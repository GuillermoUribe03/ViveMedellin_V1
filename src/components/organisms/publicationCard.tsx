...
const PublicationCard = ({ idGrupo, groupImage, groupName, author_date, textPublication, commentAuthor, comment}: PublicationCardProps) => {
    return (
        <div className="bg-white border-2 w-full border-altGray shadow-lg space-y-4 p-4 px-6 pb-12 rounded-3xl">
            <GroupCard id={idGrupo} image={groupImage} title={groupName} text={author_date}></GroupCard>
